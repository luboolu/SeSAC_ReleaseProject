...
class Stamp_10: UIView {
    ...
    private func commonInit(color: UIColor, fontSize: CGFloat) {
        Bundle.main.loadNibNamed("Stamp_10", owner: self, options: nil)
        ...
        contentLabel1.font = UIFont(name: "HeirofLightOTFBold", size: 30 + fontSize)
        
        contentLabel2.text = "\(timestamp2)"
        contentLabel2.textColor = color
        contentLabel2.font = UIFont(name: "HeirofLightOTFBold", size: 30 + fontSize)
