...
final class Stamp_6: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        commonInit(color: .white, fontName: "DungGeunMo", fontSize: 0)
    }
    
    private func commonInit(color: UIColor, fontName: String, fontSize: CGFloat) {
        Bundle.main.loadNibNamed("Stamp_6", owner: self, options: nil)
        ...
        contentLabel1.font = UIFont(name: fontName, size: 40 + fontSize)
